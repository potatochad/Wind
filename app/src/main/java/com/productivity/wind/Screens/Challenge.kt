    ...
    LazyScreen(title = { 
        ...
        LazyRuleCard("If") {
            LazzyRow {
                ...
                LazyInput(letterPoints, yes, maxW = 120)
                Text(" points")
            }
            LazzyRow {
                Text("Text retyped: ")
                LazyInput(completionPoints, yes, maxW = 120)
                Text(" points")
            }
        }
        ...
        LazyRuleCard("Other") {
            LazzyRow {
                ...
                LazyInput(Retypes, yes, maxW = 120)
            }
        }
    }
}
